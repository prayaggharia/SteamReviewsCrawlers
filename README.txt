...
owned games
numer of reviews by reviewer
reccommended (1 or -1)
hours played at the time of review (time)
posted time
content (text of the review)

The files take a very long time to run but if it stops it will start where it left off and ignore the files that have already been extracted.